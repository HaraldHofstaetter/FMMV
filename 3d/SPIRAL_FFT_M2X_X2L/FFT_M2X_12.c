...
! +-----------------------------------------------+
! Command-line options: -l -B 32 -C -xprecision=double -xposw -xsubname=FFT_M2X_12 
! 
*/
/*
! The SPL Program: (compose (permutation (...1 x 12 ...))(compose (tensor (..)(..))(compose (..)(..))))
! node size: 12 X 12
*/


	void FFT_M2X_12(double *y, double *x) {
	double f0;
	double f1;
	double f2;
	double f3;
