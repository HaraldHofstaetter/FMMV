	...
	'''      
        ...
        for neighbor in neighbors:
                ...
                for child in childs:
                        ...
                        z = 2*dir_neighbor[2] + 0.5*dir_child[2]
                        print '\ti_%s_%s_%s,' % (N[x], N[y], N[z]),
                print
        print "};"
	print
        n = 0;
          ...
          for y in [-2, -1, 0, 1, 2]:
            for z in [-2, -1, 0, 1, 2]:
                if not(abs(x)<=1 and abs(y)<=1 and abs(z)<=1):
                        print '\tir_%s_%s_%s,' % (N[2*x], N[2*y], N[2*z]),
                        i += 1
                        if i==4:
                                print
                                i = 0
...
print "/* This file is automatically generated by gen_M2L_h.py */"
print "/* DO NOT EDIT! */"
print
